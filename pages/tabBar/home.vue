<template>
	<view class="home">
			...
			<view class="swiper-box">
				<swiper circular="true" autoplay="true" @change="swiperChange">
					<swiper-item v-for="(swiper,index) in swiperList" :key="swiper.id" current="index">
						<image :src="swiper.img" @tap="toSwiper(swiper,index)"></image>
					</swiper-item>
		...
		<!-- 广告图 -->
		<view class="banner"><image src="../../static/img/category/jijian.png"></image></view>
		<!-- 活动区 -->
